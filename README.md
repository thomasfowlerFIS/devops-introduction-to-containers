...
* Describe what a container is, the rationale behind
them and their benefits.

* Understand how containers are implemented and their
connection to the container runtime and host
operating system.

* Explain the difference between a container and a
container image and their relationship to each other.
